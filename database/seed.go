...
func seedCMS(ctx context.Context, db *gorm.DB) error {
	pages := []models.Page{
		{
			...
			DescriptionEn: "A practical Europe and Asia education bridge built through real institutional collaboration, campus sessions, and career-ready programs.",
			DescriptionID: "Jembatan edukasi Eropa dan Asia yang dibangun lewat kolaborasi institusi, sesi kampus, dan program siap karier.",
			ImagePath:     "/uploads/pages/about-award-moment.webp",
			ContentEn:     "<h2>Built from real rooms, not only online screens</h2><p>Prometheus Academy connects learning, workforce readiness, and institutional partnership through direct conversations with universities, government stakeholders, and students.</p><h3>A practical bridge</h3><p>Our programs support scholarship preparation, work-abroad readiness, digital skills, and university collaboration through structured, visible activity.</p><h3>Professors from European universities</h3><p>High-quality education delivered by experienced educators who bring real-world expertise from leading institutions across Europe.</p><h3>Life-oriented courses</h3><p>Focused on real-world skills and practical application — every course is designed to create measurable outcomes, not just certificates.</p><h3>Global talent pipeline</h3><p>Through Talent Bridge and university partnerships, we extend the ecosystem beyond courses into career placement and institutional collaboration.</p>",
			ContentID:     "<h2>Dibangun dari ruang nyata, bukan hanya layar online</h2><p>Prometheus Academy menghubungkan pembelajaran, kesiapan kerja, dan kemitraan institusi melalui percakapan langsung dengan universitas, pemangku kepentingan, dan mahasiswa.</p><h3>Jembatan yang praktis</h3><p>Program kami mendukung persiapan beasiswa, kesiapan kerja luar negeri, skill digital, dan kolaborasi universitas lewat kegiatan yang terstruktur dan terlihat.</p><h3>Profesor dari universitas Eropa</h3><p>Pendidikan berkualitas dari pengajar berpengalaman yang membawa keahlian dunia nyata dari institusi terkemuka di Eropa.</p><h3>Kursus berorientasi kehidupan nyata</h3><p>Berfokus pada skill dunia nyata dan penerapan praktis — setiap kursus dirancang untuk menghasilkan hasil yang terukur, bukan sekadar sertifikat.</p><h3>Pipeline talenta global</h3><p>Melalui Talent Bridge dan kerja sama universitas, kami memperluas ekosistem melampaui kursus ke penempatan karier dan kolaborasi institusi.</p>",
		},
		{Slug: "privacy-policy", TitleEn: "Privacy Policy", TitleID: "Kebijakan Privasi", DescriptionEn: "How Prometheus Academy handles and protects your personal data.", DescriptionID: "Bagaimana Prometheus Academy mengelola dan melindungi data pribadi Anda.", ContentEn: "<h2>Data We Collect</h2><p>We collect information you provide directly: name, email, profile details, course progress, payment information, and communication preferences.</p><h2>How We Use Your Data</h2><p>Your data is used to deliver courses, process payments, send transactional emails, improve our platform, and comply with legal obligations.</p><h2>Data Sharing</h2><p>We do not sell your personal data. We share information only with payment processors (Midtrans), email service providers, and when required by law.</p><h2>Your Rights</h2><p>You can access, correct, or delete your personal data at any time through your dashboard or by contacting us.</p><h2>Data Security</h2><p>We implement industry-standard security measures including encrypted storage, secure transmission, and regular security audits.</p><h2>Contact</h2><p>For privacy inquiries, contact us at <a href='mailto:info@academyprometheus.com'>info@academyprometheus.com</a>.</p>", ContentID: "<h2>Data Yang Kami Kumpulkan</h2><p>Kami mengumpulkan informasi yang Anda berikan langsung: nama, email, detail profil, progress kursus, informasi pembayaran, dan preferensi komunikasi.</p><h2>Bagaimana Kami Menggunakan Data Anda</h2><p>Data Anda digunakan untuk mengantarkan kursus, memproses pembayaran, mengirim email transaksi, meningkatkan platform, dan mematuhi kewajiban hukum.</p><h2>Berbagi Data</h2><p>Kami tidak menjual data pribadi Anda. Kami membagikan informasi hanya dengan pemroses pembayaran (Midtrans), penyedia layanan email, dan jika diwajibkan oleh hukum.</p><h2>Hak Anda</h2><p>Anda dapat mengakses, memperbaiki, atau menghapus data pribadi kapan saja melalui dashboard atau dengan menghubungi kami.</p><h2>Keamanan Data</h2><p>Kami menerapkan langkah keamanan standar industri termasuk penyimpanan terenkripsi, transmisi aman, dan audit keamanan berkala.</p><h2>Kontak</h2><p>Untuk pertanyaan privasi, hubungi kami di <a href='mailto:info@academyprometheus.com'>info@academyprometheus.com</a>.</p>"},
		{Slug: "terms", TitleEn: "Terms of Service", TitleID: "Syarat Layanan", DescriptionEn: "Terms for using Prometheus Academy courses, services, and platform.", DescriptionID: "Syarat penggunaan kursus, layanan, dan platform Prometheus Academy.", ContentEn: "<h2>Acceptance of Terms</h2><p>By accessing Prometheus Academy, you agree to these terms. If you do not agree, please do not use our platform.</p><h2>Account Responsibility</h2><p>You are responsible for maintaining the confidentiality of your account and for all activities under your account.</p><h2>Course Access</h2><p>Enrolled courses are for personal use only. Sharing login credentials or course materials is prohibited.</p><h2>Payments & Refunds</h2><p>All payments are processed through Midtrans. Refund requests must be submitted within 7 days of purchase.</p><h2>Intellectual Property</h2><p>All course content, materials, and platform design are owned by Prometheus Academy. Reproduction without permission is prohibited.</p><h2>Limitation of Liability</h2><p>Prometheus Academy is not liable for indirect, incidental, or consequential damages arising from platform use.</p><h2>Changes to Terms</h2><p>We may update these terms periodically. Continued use after changes constitutes acceptance of the new terms.</p>", ContentID: "<h2>Penerimaan Syarat</h2><p>Dengan mengakses Prometheus Academy, Anda menyetujui syarat ini. Jika tidak setuju, mohon jangan gunakan platform kami.</p><h2>Tanggung Jawab Akun</h2><p>Anda bertanggung jawab menjaga kerahasiaan akun dan semua aktivitas yang terjadi di bawah akun Anda.</p><h2>Akses Kursus</h2><p>Kursus yang diikuti hanya untuk penggunaan pribadi. Berbagi kredensial login atau materi kursus dilarang.</p><h2>Pembayaran & Pengembalian</h2><p>Semua pembayaran diproses melalui Midtrans. Permintaan pengembalian harus diajukan dalam 7 hari setelah pembelian.</p><h2>Kekayaan Intelektual</h2><p>Semua konten kursus, materi, dan desain platform dimiliki oleh Prometheus Academy. Dilarang memperbanyak tanpa izin.</p><h2>Pembatasan Tanggung Jawab</h2><p>Prometheus Academy tidak bertanggung jawab atas kerugian tidak langsung, insidental, atau konsekuensional yang timbul dari penggunaan platform.</p><h2>Perubahan Syarat</h2><p>Kami dapat memperbarui syarat ini secara berkala. Penggunaan berlanjut setelah perubahan merupakan penerimaan syarat baru.</p>"},
	}
	...
	galleryImages := []models.PageSection{
		{PageSlug: "about", SectionKey: "founder", TitleEn: "David Nagy", TitleID: "David Nagy", ContentEn: "<p>My name is <strong>David Nagy</strong>, the dreamer and Founder of Prometheus Academy. I created this platform with one bold goal: to build the world's first online academy that goes beyond just learning.</p><p>Here, you don't just take courses — you can join real research projects, global collaborations, and startup ventures, no matter where you are in the world.</p><p>Prometheus Academy is for those who dream big and aim to succeed even bigger. Whether you're starting from scratch or looking to scale your skills, this is your place to learn, grow, and create a future without limits.</p>", ContentID: "<p>Nama saya <strong>David Nagy</strong>, pemimpi dan Pendiri Prometheus Academy. Saya membuat platform ini dengan satu tujuan berani: membangun akademi online pertama di dunia yang melampaui sekadar belajar.</p><p>Di sini, kamu tidak hanya mengikuti kursus — kamu bisa bergabung dalam proyek penelitian nyata, kolaborasi global, dan usaha rintisan, di mana pun kamu berada di dunia.</p><p>Prometheus Academy adalah untuk mereka yang bermimpi besar dan bertujuan untuk sukses lebih besar lagi. Baik kamu memulai dari nol atau ingin mengembangkan skill, ini adalah tempatmu untuk belajar, berkembang, dan menciptakan masa depan tanpa batas.</p>", ImagePath: "/uploads/pages/about-award-moment.webp", IconName: "To build the world's first online academy that goes beyond just learning.|||Membangun akademi online pertama di dunia yang melampaui sekadar belajar.", Order: 0, IsActive: true},
		{PageSlug: "about", SectionKey: "gallery", TitleEn: "Campus Collaboration", TitleID: "Kolaborasi Kampus", ContentEn: "Building partnerships with universities across Europe and Asia.", ContentID: "Membangun kemitraan dengan universitas di Eropa dan Asia.", ImagePath: "/uploads/pages/IMG_0920.JPG", Order: 1, IsActive: true},
		{PageSlug: "about", SectionKey: "gallery", TitleEn: "Student Life", TitleID: "Kehidupan Mahasiswa", ContentEn: "Capturing real moments from our learning community.", ContentID: "Mengabadikan momen nyata dari komunitas belajar kami.", ImagePath: "/uploads/pages/IMG_0921.JPG", Order: 2, IsActive: true},
		{PageSlug: "about", SectionKey: "gallery", TitleEn: "Workshop Sessions", TitleID: "Sesi Workshop", ContentEn: "Hands-on workshops that bridge theory and practice.", ContentID: "Workshop praktis yang menjembatani teori dan praktik.", ImagePath: "/uploads/pages/IMG_5913.jpeg", Order: 3, IsActive: true},
		{PageSlug: "about", SectionKey: "gallery", TitleEn: "Global Network", TitleID: "Jaringan Global", ContentEn: "Connecting talents and institutions across continents.", ContentID: "Menghubungkan talenta dan institusi lintas benua.", ImagePath: "/uploads/pages/IMG_5935.jpeg", Order: 4, IsActive: true},
		{PageSlug: "about", SectionKey: "gallery", TitleEn: "Community Events", TitleID: "Event Komunitas", ContentEn: "Where learners meet mentors and industry leaders.", ContentID: "Tempat learner bertemu mentor dan pemimpin industri.", ImagePath: "/uploads/pages/IMG_9298.jpeg", Order: 5, IsActive: true},
		{PageSlug: "about", SectionKey: "gallery", TitleEn: "Team Building", TitleID: "Team Building", ContentEn: "Fostering collaboration and cross-cultural connections.", ContentID: "Mendorong kolaborasi dan koneksi lintas budaya.", ImagePath: "/uploads/pages/IMG_9340.jpeg", Order: 6, IsActive: true},
		{PageSlug: "about", SectionKey: "gallery", TitleEn: "Achievement Moments", TitleID: "Momen Pencapaian", ContentEn: "Celebrating milestones and breakthroughs together.", ContentID: "Merayakan pencapaian dan terobosan bersama.", ImagePath: "/uploads/pages/4ab4bb9a-3662-4a7a-a021-33f7bfadd85e.jpeg", Order: 7, IsActive: true},
		{PageSlug: "about", SectionKey: "gallery", TitleEn: "Behind the Scenes", TitleID: "Di Balik Layar", ContentEn: "The people and energy that make it all happen.", ContentID: "Orang-orang dan energi yang mewujudkan semuanya.", ImagePath: "/uploads/pages/WhatsApp Image 2026-05-08 at 19.34.05 (2).jpeg", Order: 8, IsActive: true},
	}
	for _, item := range galleryImages {
		section := item
		match := models.PageSection{PageSlug: section.PageSlug, SectionKey: section.SectionKey}
		if section.SectionKey == "gallery" {
			match.Order = section.Order
		}
		if err := db.WithContext(ctx).Where(match).Attrs(section).FirstOrCreate(&section).Error; err != nil {
			return fmt.Errorf("seed page section %s/%s: %w", section.PageSlug, section.SectionKey, err)
		}
	}
	...
	testimonials := []models.Testimonial{
		{Name: "Nadia Putri", Role: "Scholarship Applicant", Company: "Indonesia", Avatar: "/uploads/avatars/avatar-1780837099489305300.webp", ContentEn: "The roadmap made my IELTS preparation and scholarship documents feel structured.", ContentID: "Roadmap-nya bikin persiapan IELTS dan dokumen beasiswa jadi jauh lebih terarah.", Rating: 5, ReviewSource: "student", DisplayContext: "general", ReviewStatus: "approved", IsActive: true},
		{Name: "Nadia Scholarship Story", Role: "Scholarship Applicant", Company: "Indonesia", Avatar: "/uploads/media/academy-student-session.webp", ContentEn: "The weekly structure helped me prepare IELTS, essays, and scholarship documents with a clearer rhythm.", ContentID: "Struktur mingguannya membantu saya menyiapkan IELTS, esai, dan dokumen beasiswa dengan ritme yang lebih jelas.", Rating: 5, ReviewSource: "student", DisplayContext: "general", ReviewStatus: "approved", IsActive: true},
		{Name: "Arif Pratama", Role: "Digital Skills Learner", Company: "Indonesia", Avatar: "/uploads/media/academy-student-session.webp", ContentEn: "Prometheus helped me turn scattered learning goals into a weekly plan I could actually follow.", ContentID: "Prometheus membantu saya mengubah target belajar yang berantakan jadi rencana mingguan yang bisa benar-benar saya ikuti.", Rating: 5, ReviewSource: "student", DisplayContext: "general", ReviewStatus: "approved", IsActive: true},
		{Name: "Student Video Story", Role: "Video Testimonial", Company: "Prometheus Academy", ContentEn: "A short student video story can be replaced from Home Testimonials in admin.", ContentID: "Cerita video student singkat ini bisa diganti dari Home Testimonials di admin.", Rating: 5, ReviewSource: "student", DisplayContext: "general", ReviewStatus: "approved", SourceURL: "https://www.youtube.com/watch?v=jNQXAC9IVRw", IsActive: true},
		...
		{Name: "Raka Wibowo", Role: "UI/UX Learner", Company: "Jakarta", Avatar: "/uploads/media/academy-internship-panel.webp", ContentEn: "The course pushed me to finish a portfolio case study that recruiters could actually read.", ContentID: "Kursusnya mendorong saya menyelesaikan studi kasus portofolio yang benar-benar bisa dibaca recruiter.", Rating: 5, ReviewSource: "student", DisplayContext: "general", ReviewStatus: "approved", IsActive: true},
		{Name: "Daniel Meyer", Role: "Hiring Manager", Company: "Munich Product Team", Avatar: "/uploads/media/academy-international-visit.webp", ContentEn: "The candidate shortlist felt practical because Prometheus understood both remote delivery and operational support.", ContentID: "Shortlist kandidat terasa praktis karena Prometheus memahami delivery remote sekaligus dukungan operasional.", Rating: 5, ReviewSource: "student", DisplayContext: "talent_bridge", ReviewStatus: "approved", IsActive: true},
	...
	banners := []models.Banner{
		{TitleEn: "Europe x Asia learning bridge", TitleID: "Jembatan belajar Eropa x Asia", ImagePath: "/uploads/media/academy-international-visit.webp", LinkURL: "/about", IsActive: true, Order: 1},
		{TitleEn: "Campus partnership moment", TitleID: "Momen kemitraan kampus", ImagePath: "/uploads/media/academy-lampung-partnership.webp", LinkURL: "/about", IsActive: true, Order: 2},
		{TitleEn: "Student learning session", TitleID: "Sesi belajar student", ImagePath: "/uploads/media/academy-student-session.webp", LinkURL: "/about", IsActive: true, Order: 3},
		{TitleEn: "Internship preparation panel", TitleID: "Panel persiapan internship", ImagePath: "/uploads/media/academy-internship-panel.webp", LinkURL: "/about", IsActive: true, Order: 4},
		{TitleEn: "Ministry collaboration", TitleID: "Kolaborasi kementerian", ImagePath: "/uploads/media/academy-ministry-team.webp", LinkURL: "/about", IsActive: true, Order: 5},
		{TitleEn: "MOU signing session", TitleID: "Sesi penandatanganan MOU", ImagePath: "/uploads/media/academy-mou-signing.webp", LinkURL: "/about", IsActive: true, Order: 6},
	}
	for _, item := range banners {
		...
		if err := db.WithContext(ctx).Where(models.Banner{TitleEn: banner.TitleEn}).Attrs(banner).FirstOrCreate(&banner).Error; err != nil {
			return fmt.Errorf("seed banner %s: %w", item.TitleEn, err)
		}
	}

	trustPhotos := []models.TalentTrustPhoto{
		{TitleEn: "International campus visit", TitleID: "Kunjungan kampus internasional", Category: "university", ImagePath: "/uploads/media/academy-international-visit.webp", Order: 1, IsActive: true},
		{TitleEn: "Partnership meeting", TitleID: "Pertemuan kemitraan", Category: "client", ImagePath: "/uploads/media/academy-lampung-partnership.webp", Order: 2, IsActive: true},
		{TitleEn: "Student session", TitleID: "Sesi student", Category: "session", ImagePath: "/uploads/media/academy-student-session.webp", Order: 3, IsActive: true},
		{TitleEn: "Internship panel", TitleID: "Panel internship", Category: "event", ImagePath: "/uploads/media/academy-internship-panel.webp", Order: 4, IsActive: true},
		{TitleEn: "Ministry team moment", TitleID: "Momen bersama kementerian", Category: "community", ImagePath: "/uploads/media/academy-ministry-team.webp", Order: 5, IsActive: true},
		{TitleEn: "MOU signing", TitleID: "Penandatanganan MOU", Category: "client", ImagePath: "/uploads/media/academy-mou-signing.webp", Order: 6, IsActive: true},
	}
	for _, item := range trustPhotos {
		photo := item
		if err := db.WithContext(ctx).Where(models.TalentTrustPhoto{TitleEn: photo.TitleEn}).Attrs(photo).FirstOrCreate(&photo).Error; err != nil {
			return fmt.Errorf("seed talent trust photo %s: %w", item.TitleEn, err)
		}
	}
	...
	templates := []models.EmailTemplate{
		...
		{DesignID: defaultEmailDesign.ID, Key: "talent_portal_invite", SubjectEn: "Set up your Talent Bridge dashboard", SubjectID: "Buat password dashboard Talent Bridge", PreheaderEn: "Set your password to track your Talent Bridge+ application.", PreheaderID: "Buat password untuk memantau aplikasi Talent Bridge+ kamu.", BodyEn: seedEmailTemplateHTML("Your Talent Bridge application is ready to track", `<p>Hi {name},</p><p>We received your <strong>{application_type}</strong> application and created a Student account for this email.</p><p>Use the secure link below to set your password.</p><p><a href="{reset_url}" style="display:inline-block;background:#C9A84C;color:#0D1B2E;text-decoration:none;border-radius:10px;padding:12px 18px;font-weight:800;">Set Password</a></p><p><a href="{dashboard_url}" style="color:#C9A84C;font-weight:700;">Open Student Dashboard</a></p>`, "Prometheus Academy Talent Bridge team."), BodyID: seedEmailTemplateHTML("Aplikasi Talent Bridge kamu siap dipantau", `<p>Hai {name},</p><p>Kami menerima aplikasi <strong>{application_type}</strong> kamu dan membuat akun Student untuk email ini.</p><p>Gunakan link aman di bawah untuk membuat password.</p><p><a href="{reset_url}" style="display:inline-block;background:#C9A84C;color:#0D1B2E;text-decoration:none;border-radius:10px;padding:12px 18px;font-weight:800;">Buat Password</a></p><p><a href="{dashboard_url}" style="color:#C9A84C;font-weight:700;">Buka Dashboard Student</a></p>`, "Tim Prometheus Academy Talent Bridge."), FooterEn: "<p>Prometheus Academy Talent Bridge team.</p>", FooterID: "<p>Tim Prometheus Academy Talent Bridge.</p>", BackgroundColor: "#F8F9FA", AccentColor: "#C9A84C"},
		...
		{DesignID: defaultEmailDesign.ID, Key: "company_portal_invite", SubjectEn: "Open your Talent Bridge company dashboard", SubjectID: "Buka company dashboard Talent Bridge", PreheaderEn: "Set your password to view hiring requests and follow-up progress.", PreheaderID: "Buat password untuk melihat request hiring dan progress follow-up.", BodyEn: seedEmailTemplateHTML("Your company dashboard is ready", `<p>Hi {name},</p><p>We received the hiring inquiry for <strong>{company_name}</strong>.</p><p>Use the secure link below to set your password, then open your company dashboard with the same work email.</p><p><a href="{reset_url}" style="display:inline-block;background:#C9A84C;color:#0D1B2E;text-decoration:none;border-radius:10px;padding:12px 18px;font-weight:800;">Set Password</a></p><p><a href="{company_dashboard_url}" style="color:#C9A84C;font-weight:700;">Open company dashboard</a></p>`, "Prometheus Academy Talent Bridge team."), BodyID: seedEmailTemplateHTML("Company dashboard kamu siap", `<p>Hai {name},</p><p>Kami menerima permintaan hiring untuk <strong>{company_name}</strong>.</p><p>Gunakan link aman di bawah untuk membuat password, lalu buka company dashboard dengan email kerja yang sama.</p><p><a href="{reset_url}" style="display:inline-block;background:#C9A84C;color:#0D1B2E;text-decoration:none;border-radius:10px;padding:12px 18px;font-weight:800;">Buat Password</a></p><p><a href="{company_dashboard_url}" style="color:#C9A84C;font-weight:700;">Buka company dashboard</a></p>`, "Tim Prometheus Academy Talent Bridge."), FooterEn: "<p>Prometheus Academy Talent Bridge team.</p>", FooterID: "<p>Tim Prometheus Academy Talent Bridge.</p>", BackgroundColor: "#F8F9FA", AccentColor: "#C9A84C"},
